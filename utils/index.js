...
export const TYPES = {
  ...
  HIRE: "HIRE",
  POYNT: "POYNT",
  "APPLICATION-2024": "APPLICATION-2024",
  "ADD-LOCATION": "ADD-LOCATION",
  "HIRE-2024": "HIRE-2024",
};

const WEBHOOK_URL = "https://jiggle.5tel.co.uk/rest/1/96a0w2k9heuzzle0/";
...
export async function getFields(deal, type) {
  const LEGAL_NAME = deal["UF_CRM_66879DD074993"];
  ...
  const MID_NUMBER = deal["UF_CRM_1724854282074"];
  ...
  let parentEntityCode;

  if (deal["UF_CRM_1724935712004"] == 657) parentEntityCode = "52898";
  else if (deal["UF_CRM_1724935712004"] == 659) parentEntityCode = "52042";
  else if (deal["UF_CRM_1724935712004"] == 661) parentEntityCode = "52043";
  else if (deal["UF_CRM_1724935712004"] == 663) parentEntityCode = "53525";
  else parentEntityCode = "";
  ...
  const fields = {
    ...
    APPLICATION: {
      FUNDING: deal["UF_CRM_1724854048086"],
      "FUNDING 1": deal["UF_CRM_1724854065993"],
      "FUNDING 2": deal["UF_CRM_1724854118546"],
      // "FUNDING 3": deal[""],
      // "FUNDING 4": deal[""],
      // "FUNDING 5": deal[""],
      "FUNDING 6": parentEntityCode,
      "FUNDING 7": deal["UF_CRM_1724854282074"],
      // "FUNDING 8": deal[""],
      // "FUNDING 9": deal[""],
      "FUNDING 12": deal["UF_CRM_1724854334479"],
      "FUNDING 47": deal["UF_CRM_1724853896562"],
      Text1: deal["UF_CRM_1724903641168"],
    ...
    "APPLICATION-2024": {
      ...
      "Legal Name 2": MID_NUMBER, // MID Number
      "Legal Name": deal["UF_CRM_66879DD09AF41"], // currency code
      "Legal Name 310scryrpv28hg1": deal["UF_CRM_66879DD0A7044"], // parent chain number
      "Legal Name 410scryrpv28hg2": deal["UF_CRM_66879DD0B671B"], // american express number
    ...
    "ADD-LOCATION": {
      ...
      "Legal Name": deal["UF_CRM_66879DD09AF41"], // currency code
      "Legal Name 3": deal["UF_CRM_66879DD0A7044"], // parent chain number
      "Legal Name 412so2mz0k49fq1": deal["UF_CRM_66879DD0B671B"], // american express number
      ...
      // DD Section
      "Legal Name 312so2mz0k49fq3": LEGAL_NAME, // Legal Name
      // Bank account number
      "Bank Number": deal["UF_CRM_6687D4F0C95F0"][0],
      "Bank Number 1": deal["UF_CRM_6687D4F0C95F0"][1],
      "Bank Number 2": deal["UF_CRM_6687D4F0C95F0"][2],
...
export async function processDeal(deal, dealId) {
  ...
  modifyPdf(deal, dealId, TYPES["APPLICATION-2024"]);
  modifyPdf(deal, dealId, TYPES["ADD-LOCATION"]);
  modifyPdf(deal, dealId, TYPES["HIRE-2024"]);
}
...
export async function modifyPdf(deal, dealId, type) {
  ...
  if (type === TYPES.APPLICATION) {
    ...
    const singleChecks = [
      {
        field: "UF_CRM_1724853784888",
        value: "1",
        checkbox: "C1010",
      },
      {
        field: "UF_CRM_66ACE6D1C92BC",
        value: "1",
        checkbox: "C1011",
      },
      {
        field: "UF_CRM_1724853866459",
        value: "1",
        checkbox: "C1012",
      },
      //
  ...
  if (type === TYPES["APPLICATION-2024"]) {
    // APPLICATION Section
    const checkboxes = ["C129", "C130", "C131", "C132", "C133", "C134", "C135"];
    const multiSelectFields = [
      {
    ...
    SOFCheckboxes.forEach((field, index) => {
      if (deal[field] === "1") {
        const checkBox = form.getCheckBox(`C10${4 + index}`);
        checkBox.check();
      }
